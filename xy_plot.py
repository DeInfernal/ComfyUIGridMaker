...
def parse_args():
    ...
    parser.add_argument("--skip_mass_generation", action="store_false", help="Set the flag to skip the step with generation of XY plot (only make images)")
...
if __name__ == "__main__":
    ...
    renderer.render(plotfile, args.skip_mass_generation, **kwargs)
