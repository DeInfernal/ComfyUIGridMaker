...
def parse_args():
    ...
    parser.add_argument("--output_type", choices=["apng", "webp", "mp4", "mp4_averaged1", "mp4_averaged2", "mp4_averaged3", "webm"], default="webp", nargs="+", help="Set the output file type, can be multiple")
